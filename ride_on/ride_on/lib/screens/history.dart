...
//                    generateHistoryTableRow(rideHistory[0]),
                ...
                if(newRideHistory.length >= 6) TableRow(
                  children: <Widget>[
                    ...
                    Text('\t' + newRideHistory[5].getDistance().toString() + 'mi',
                      style: tableData(),
                    ),
                  ],
                ),
                if(newRideHistory.length >= 7) TableRow(
                  children: <Widget>[
                    ...
                    Text('\t' + newRideHistory[6].getDistance().toString() + 'mi',
                      style: tableData(),
                    ),
                  ],
                ),
                if(newRideHistory.length >= 8) TableRow(
                  children: <Widget>[
                    ...
                    Text('\t' + newRideHistory[7].getDistance().toString() + 'mi',
                      style: tableData(),
                    ),
                  ],
                ),
                if(newRideHistory.length >= 9) TableRow(
                  children: <Widget>[
                    ...
                    Text('\t' + newRideHistory[8].getDistance().toString() + 'mi',
                      style: tableData(),
                    ),
                  ],
                ),
                if(newRideHistory.length >= 10) TableRow(
                  children: <Widget>[
                    ...
                    Text('\t' + newRideHistory[9].getDistance().toString() + 'mi',
                      style: tableData(),
                    ),
                  ],
                ),
